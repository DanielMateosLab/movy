...
export type ResolversTypes = {
  ...
  ShowsByTitleResponse: ResolverTypeWrapper<ShowsByTitleResponse>;
...
export type ResolversParentTypes = {
  ...
  Query: {};
  Show: Show;
  ShowsByTitleResponse: ShowsByTitleResponse;
...
> = {
  showById?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryShowByIdArgs, "id">
  >;
  showsByTitle?: Resolver<
    ResolversTypes["ShowsByTitleResponse"],
    ParentType,
    ContextType,
    RequireFields<QueryShowsByTitleArgs, "title">
  >;
};
...
export type ShowsByTitleResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ShowsByTitleResponse"] = ResolversParentTypes["ShowsByTitleResponse"]
> = {
  page?: Resolver<ResolversTypes["Int"], ParentType, ContextType>;
  result?: Resolver<
    Array<Maybe<ResolversTypes["Show"]>>,
    ParentType,
    ContextType
  >;
